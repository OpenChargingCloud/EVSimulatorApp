...
internal fun encodeWPT_ChargeLoopResType(w: BitWriter, msg: WPT_ChargeLoopResType) {
    w.writeBits(0u, 1)   // SE
...
internal fun decodeWPT_ChargeLoopResType(r: BitReader): WPT_ChargeLoopResType {
    r.readBits(1)   // SE
