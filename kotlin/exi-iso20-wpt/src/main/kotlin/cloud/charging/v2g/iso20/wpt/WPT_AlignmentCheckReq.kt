...
internal fun encodeWPT_AlignmentCheckReq(w: BitWriter, msg: WPT_AlignmentCheckReq) {
    w.writeBits(0u, 1)   // SE
...
internal fun decodeWPT_AlignmentCheckReq(r: BitReader): WPT_AlignmentCheckReq {
    r.readBits(1)   // SE
