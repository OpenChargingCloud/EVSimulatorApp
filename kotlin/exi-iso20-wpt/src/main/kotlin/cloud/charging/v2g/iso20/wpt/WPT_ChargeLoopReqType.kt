...
internal fun encodeWPT_ChargeLoopReqType(w: BitWriter, msg: WPT_ChargeLoopReqType) {
    w.writeBits(0u, 1)   // SE
...
internal fun decodeWPT_ChargeLoopReqType(r: BitReader): WPT_ChargeLoopReqType {
    r.readBits(1)   // SE
