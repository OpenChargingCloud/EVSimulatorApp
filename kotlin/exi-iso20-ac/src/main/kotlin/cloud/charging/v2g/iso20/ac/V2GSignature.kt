...
/**
 * XMLDSig signing and verification for ISO 15118-20 AC.
 *
 ...
 * the whole set: SignedInfo is event code 135 at 8 bits here, against 230 at 9 bits in
 ...
 * nowhere else.
 *
 * The element this set signs is `AC_ChargeParameterDiscoveryRes`, whose fragment codec the generator
...
object V2GSignature {
    ...
    fun signedInfoFragment(signedInfo: SignedInfoType): ByteArray =
        ACCodec.encodeFragment_SignedInfo(signedInfo)
