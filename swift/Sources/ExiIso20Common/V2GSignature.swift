...
/// The ISO 15118-20 CommonMessages half of the -20 signature suite: SHA-512 over a signed element's EXI
...
/// set — so the *same* `SignedInfo` lands on a different event code in each. Here it is **230 over 9 bits**.
