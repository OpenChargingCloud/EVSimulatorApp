    ...
    public class CrossEmitterComparisonTests
    {
        ...
        public void SwiftAndCSharpAgreeOperationForOperation()
        {
            ...
            var swift  = CrossEmitterComparison.Operations(
                             EmitterHarness.Emit(SwiftCodecEmitter.Instance, "app", "SupportedAppProtocolCodec", schema));
        ...
        public void KotlinAndCSharpAgreeOperationForOperation()
        {
            ...
            var kotlin = CrossEmitterComparison.Operations(
                             EmitterHarness.Emit(KotlinCodecEmitter.Instance, "app", "SupportedAppProtocolCodec", schema));
            var csharp = CrossEmitterComparison.Operations(
                             EmitterHarness.EmitCSharp("Test.App", "SupportedAppProtocolCodec", schema));
        ...
        public void SwiftAndCSharpAgreeAcrossTheWholeIso2Set()
        {
            ...
            AssertAgrees(EmitterHarness.Emit(SwiftCodecEmitter.Instance, "iso2", "Iso15118_2Codec", schema), "swift",
        ...
        public void KotlinAndCSharpAgreeAcrossTheWholeIso2Set()
        {
            ...
            AssertAgrees(EmitterHarness.Emit(KotlinCodecEmitter.Instance, "iso2", "Iso15118_2Codec", schema), "kotlin",
                         EmitterHarness.EmitCSharp("Iso2", "Iso15118_2Codec", schema));
        }
        ...
        public void SwiftAndCSharpAgreeAcrossAnIso20Set(string project, string codec)
        {
            ...
            AssertAgrees(EmitterHarness.Emit(SwiftCodecEmitter.Instance, "c20", codec, schema), "swift",
        ...
        public void KotlinAndCSharpAgreeAcrossAnIso20Set(string project, string codec)
        {
            ...
            AssertAgrees(EmitterHarness.Emit(KotlinCodecEmitter.Instance, "c20", codec, schema), "kotlin",
                         EmitterHarness.EmitCSharp("C20", codec, schema));
        }
            ...
            string project, string codec, bool hasSwift)
        {
            ...
            var kotlin = CrossEmitterComparison.DocumentIndexMap(EmitterHarness.Emit(KotlinCodecEmitter.Instance, "ref", codec, schema));
            ...
            if (hasSwift)
                Assert.That(CrossEmitterComparison.DocumentIndexMap(EmitterHarness.Emit(SwiftCodecEmitter.Instance, "ref", codec, schema)),
