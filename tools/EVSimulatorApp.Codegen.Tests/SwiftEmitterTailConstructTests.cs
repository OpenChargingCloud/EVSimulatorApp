...
namespace cloud.charging.open.protocols.ISO15118.EXI.Tests
{
    ...
    public class SwiftEmitterTailConstructTests
    {
        ...
        {
            var swift  = CrossEmitterComparison.Operations(EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema(body)));
        ...
        {
            var pick = EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema(ChoiceSchema))
        ...
        {
            var tagged = EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema(SimpleContentSchema))
        ...
        {
            var doc = EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema(OptionalSubstitutionSchema))
