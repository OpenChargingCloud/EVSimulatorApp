...
namespace cloud.charging.open.protocols.ISO15118.EXI.Tests
{
    ...
    public class SwiftEmitterInheritanceTests
    {
        ...
        {
            var files = EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema());
        ...
        {
            var swift  = CrossEmitterComparison.Operations(EmitterHarness.Emit(SwiftCodecEmitter.Instance, "test", "TestCodec", Schema()));
